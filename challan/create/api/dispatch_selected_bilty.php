...
try {
    $updatedCount = updateDispatchRows($conn, 'biltys', 'id', $cleanIds, $company_id, "status = 'Dispatch', challan_id = NULL", "status = 'Booked'");
    $updatedCount += updateDispatchRows($conn, 'inword_biltys', 'id', $cleanInwordIds, $company_id, "status = 'Dispatch', challan_id = NULL", "status = 'Booked'");
...
echo json_encode([
    ...
    'message' => $updatedCount > 0
        ? 'Selected bilty dispatched successfully'
        : 'No booked bilty updated'
]);
